...
const Container = tw.div`relative bg-cool-gray-900 border rounded-lg border-gray-800 shadow-lg text-gray-100 -mb-8 -mx-8 px-8 py-20 lg:py-24`;
...
const Divider = tw.div`my-16 border-b-2 border-green-300 w-full`;
...
const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`absolute top-0 left-0 w-80 h-80 transform -translate-x-20 -translate-y-32 text-red-300 opacity-25`;
const DecoratorBlob2 = tw(
  SvgDecoratorBlob1
)`absolute bottom-0 right-0 w-80 h-80 transform  translate-x-32 translate-y-48 text-red-300 opacity-25`;
    ...
    <Container>
      <Content>
        ...
        <ThreeColRow>
          ...
          <CopywrightNotice>
            &copy; 2021 Crypto Funnel. All Rights Reserved.
          </CopywrightNotice>
