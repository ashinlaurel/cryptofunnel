...
import BitcoinMain from "../../../images/Marketing/4.png";
...
const RightColumn = tw.div`relative  lg:w-6/12   lg:mt-0  flex flex-1 flex-col justify-center lg:self-end`;
  ...
  return (
    <>
      ...
      <Container>
        <TwoColumn>
          <LeftColumn>
            <Heading>Display Advertising</Heading>
            <Paragraph>
